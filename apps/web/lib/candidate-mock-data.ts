import type { ApplicationStatus, EmploymentType, ExperienceLevel } from "./mock-data";

export interface MockApplicationTimelineEvent {
  id: string;
  type: "applied" | "status_change" | "interview_scheduled" | "message_received" | "reviewed";
  title: string;
  description: string;
  timestamp: string;
...
export const MOCK_CANDIDATE_APPLICATIONS_DETAIL: MockCandidateApplicationDetail[] = [
  {
    ...
    skills: ["React", "TypeScript", "Next.js", "Tailwind CSS", "GraphQL", "Playwright"],
    coverLetter:
    ...
    matchGaps: [
      "Consider highlighting GraphQL experience more prominently",
    ],
    timeline: [
      {
        id: "tl-001-1",
  ...
  },
  {
    ...
    skills: ["React", "TypeScript", "Design Systems", "GraphQL", "Performance", "A11y", "Webpack"],
    coverLetter: null,
    resumeUrl: "/resume-alex-johnson.pdf",
    linkedinUrl: "https://linkedin.com/in/alexjohnson",
    relevanceScore: 0.85,
  ...
  },
  {
    ...
    skills: ["React", "Next.js", "TypeScript", "Turbopack", "Vercel", "Open Source"],
    coverLetter:
  ...
  },
  {
    ...
    skills: ["TypeScript", "React", "Canvas API", "WebGL", "CSS", "Performance"],
    coverLetter:
  ...
  },
  {
    ...
    skills: ["Go", "Kubernetes", "Docker", "AWS", "Terraform", "CI/CD", "Python"],
    coverLetter: null,
    resumeUrl: "/resume-alex-johnson.pdf",
    linkedinUrl: "https://linkedin.com/in/alexjohnson",
    relevanceScore: 0.58,
