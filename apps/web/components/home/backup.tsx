...
function Logo(props?: { whiteOnly?: boolean }) {
  return (
    <Link href="/" className="flex items-center gap-2.5">
      ...
      <p className="font-mono text-[15px] leading-none font-bold tracking-tight">
        Hack
        <span className={cn(props?.whiteOnly ? 'text-white' : 'text-primary')}>
          Hyre
        </span>
      </p>
    </Link>
...
function AuthenticatedActions({ user }: { user: HeaderUser }) {
  ...
  return (
    <div className="flex items-center gap-1">
      ...
      <Separator orientation="vertical" className="mx-2 hidden h-5 xl:block" />
...
export function Header({ user }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-50 border-b bg-black backdrop-blur-xl">
        ...
        <div className="flex items-center gap-2">
          ...
          <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
            ...
            <SheetContent side="right" className="w-80 p-0">
              ...
              {/* Mobile user section / auth buttons */}
