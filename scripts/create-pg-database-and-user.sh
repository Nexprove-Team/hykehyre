...
Options:
  ...
  --orm ORM                prisma | typeorm | sequelize | django | drizzle | generic
...
[[ -z "$ORM" ]] && read -r -p "ORM (prisma/typeorm/sequelize/django/drizzle/generic): " ORM
...
case "$ORM" in
  prisma|typeorm|sequelize|django|drizzle)
